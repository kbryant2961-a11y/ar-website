...
const sections = [
  {
    ...
    title: (
      <>
        <span className="hidden lg:inline">Surplus funds</span>
        <span className="lg:hidden">Funds</span>
      </>
    ),
  },
            ...
            >
              {!open && (
                <>
                  <span
                    aria-hidden="true"
                    className="font-mono text-sm text-[#8f2f62]"
                  >
              ...
              <a
                ...
                className={clsx(
                  ...
                  sectionIndex === activeIndex
                    ? 'border-[#8f2f62] bg-[#fff8f5] text-[#8f2f62] before:text-[#8f2f62]'
                    : 'border-transparent before:text-slate-500 hover:bg-[#fff8f5] hover:before:text-slate-900',
                )}
              >
                {section.title}
              </a>
